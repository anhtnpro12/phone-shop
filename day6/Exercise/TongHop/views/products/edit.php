...
<div class="container mt-5 mb-5 d-flex justify-content-center">
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" style="width: 50%;">
        ...
        <div class="mb-3">
            ...
            <input type="text" value="<?php echo $product->price; ?>" name="price" class="form-control" id="price" required>
        </div>        
        <div class="mb-3">
            <label for="quantity" class="form-label">Quantity</label>
            <input type="number" value="<?php echo $product->quantity; ?>" name="quantity" class="form-control" id="quantity" required>
        </div>
        <div class="mb-3">

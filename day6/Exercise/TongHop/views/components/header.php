        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page === 'ship' ? 'active' : ''; ?>" href="../shippings/index.php">Shipping</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page === 'pay' ? 'active' : ''; ?>" href="../payments/index.php">Payment</a>
                    </li>
                </ul>
